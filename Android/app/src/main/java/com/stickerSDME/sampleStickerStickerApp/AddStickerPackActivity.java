...
import com.stickerSDME.sampleStickerStickerApp.BaseActivity;
...
public abstract class AddStickerPackActivity extends BaseActivity {
    ...
    protected void addStickerPackToWhatsApp(String identifier, String stickerPackName) {
        try {
            ...
            if (!com.stickerSDME.sampleStickerStickerApp.WhitelistCheck.isWhatsAppConsumerAppInstalled(getPackageManager()) && !WhitelistCheck.isWhatsAppSmbAppInstalled(getPackageManager())) {
